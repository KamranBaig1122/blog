<?php
  ...
  $current_user_post = $_SESSION['user-id'];
  $query = "SELECT id, title, category_id FROM posts WHERE author_id=$current_user_post ORDER BY id DESC";
    ...
    <div class="container dashboard_container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="index.php" class="active"><i class="uil uil-postcard"></i><h5>Manage Posts</h5></a></li>
                ...
                <li><a href="manageCategory.php"><i class="uil uil-list-ul"></i><h5>Manage Category</h5></a></li>
                <?php endif ?>
            </ul>
        </aside>
        <main>
