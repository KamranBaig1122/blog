...
$festured_query = "SELECT * FROM posts WHERE is_featured=1";
$featured_result = mysqli_query($connection, $festured_query);
    ...
    <section class="featured">
        <div class="container featured_container">
            <div class="post_thumbnail">
                <img src="images/<?= $featured['thumbnail'] ?>" alt="1">
            </div>
            <div class="post_info">
                <?php
                ...
                ?>
                <a href="<?= ROOT_URL ?>categoryPosts.php?id=<?= $featured['category_id'] ?>" class="category_button"><?= $category['title'] ?></a>
